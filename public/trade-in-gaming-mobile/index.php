...
<html>
<head>
	<title>Trade In Gaming Mobile</title>
...
<h1 style="margin-top: 10px;   text-align: center;">Trade In Launching ASUS ROG 5</h1>
    
    <div id="images">
    <img class="logo" src="https://www.jd.id/news/wp-content/uploads/2020/06/JDID_4-1024x1024.png" alt="" style="height: 150px;">
    <img class="logo" src="https://zfix.id/trade-in-gaming-mobile/asset/img/rog.png" alt="" style="height: 150px;">
    </div>
   ...
   <div class="container">
      <div class="jumbotron">
         ...
         <div id="price" style="text-align: center;">
            <p>Pilih Brand dan Variant Name untuk menampilkan Grade.</p>
         </div>
      </div>
   </div>
   <div class="rule">
