        ...
        @else
            <div class="dropdown" id="kt_quick_search_toggle">
                ...
                <div class="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-anim-up dropdown-menu-lg">
                    @include('layout.back_web.partial.extras.dropdown._search-dropdown')
                </div>
            </div>
        @endif
    @endif
    ...
    @if (config('layout.extras.notifications.display'))
        ...
        @else
            <div class="dropdown">
                ...
                <div class="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-anim-up dropdown-menu-lg">
                    <form>
                        @include('layout.back_web.partial.extras.dropdown._notifications')
                    </form>
                </div>
            </div>
        @endif
    ...
    @if (config('layout.extras.quick-actions.display'))
        ...
        @else
            <div class="dropdown">
                ...
                {{-- Dropdown --}}
                <div class="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-anim-up dropdown-menu-lg">
                    @include('layout.back_web.partial.extras.dropdown._quick-actions')
                </div>
            </div>
        @endif
    @endif
    ...
    @if (config('layout.extras.cart.display'))
        <div class="dropdown">
            ...
            <div class="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-xl dropdown-menu-anim-up">
                <form>
                    @include('layout.back_web.partial.extras.dropdown._cart')
                </form>
            </div>
        </div>
    @endif
    ...
    @if (config('layout.extras.languages.display'))
        <div class="dropdown">
            ...
            <div class="dropdown-menu p-0 m-0 dropdown-menu-anim-up dropdown-menu-sm dropdown-menu-right">
                @include('layout.back_web.partial.extras.dropdown._languages')
            </div>
        </div>
    @endif
        ...
        @if (config('layout.extras.user.layout') == 'offcanvas')
            <div class="topbar-item">
                <div class="btn btn-icon w-auto btn-clean d-flex align-items-center btn-lg px-2" id="kt_quick_user_toggle">
                    ...
                    <span class="text-dark-50 font-weight-bolder font-size-base d-none d-md-inline mr-3 text-capitalize">{{ $currentUser->name}}</span>
        ...
        @else
            <div class="dropdown">
                ...
                <div class="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-anim-up dropdown-menu-lg p-0">
                    @include('layout.back_web.partial.extras.dropdown._user')
                </div>
            </div>
        @endif
    @endif
