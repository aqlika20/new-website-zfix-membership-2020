...
@section('content')
                                ...
                                <div class="card card-custom">
                                        ...
                                        <table class="datatable datatable-borderless" id="register_new_partner">
                                            ...
                                            @foreach ($partners as $partner)
                                                <tr>
                                                    ...
                                                    <td>{{ $partner->pic }}</td>
                                                    <td>{{ $partner->contact_pic }}</td>
                                                    <td>{{ $partner->partner_key }}</td>
                                                    <td>
                                                        <form method="POST" action="{{ route('partner.register-new-partner.delete',[$partner->id]) }}">
                                                            @csrf 
                                                            @method('DELETE')
                                                            <a href="{{ route('partner.register-new-partner.detail',[$partner->id]) }}" title="Detail" class="btn btn-icon btn-light btn-sm mx-1">
                                                                {{ Metronic::getSVG("media/svg/icons/Files/File.svg", "svg-icon-md svg-icon-primary") }}
                                                            </a>
                                                            <a href="{{ route('partner.register-new-partner.view',[$partner->id]) }}" title="Edit" class="btn btn-icon btn-light btn-sm mx-1">
                                    ...
                                    <div class="modal-dialog" role="document">
                                        ...
                                        <form method="POST" action="{{ route('partner.register-new-partner.create') }}">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="form-group row">
                                                    <label for="contact_pic" class="col-md-4 col-form-label text-md-right">{{ __('Contact PIC') }}</label>

                                                    <div class="col-md-6">
                                                        <input id="contact_pic" type="tel" pattern="[0-9]+" class="form-control @error('contact_pic') is-invalid @enderror" name="contact_pic" required autocomplete="contact_pic" autofocus>
                                                    </div>
                                                </div>
