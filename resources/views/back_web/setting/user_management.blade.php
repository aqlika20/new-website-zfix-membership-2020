...
@section('content')
                                ...
                                <div class="card card-custom">
                                        ...
                                        <table class="datatable datatable-borderless" id="user_management">
                                            ...
                                            @foreach ($users as $user)
                                                <tr>
                                                    ...
                                                    <td>{{ $user->roles->id }}</td>
                                                    <td>
                                                        <form method="POST" action="{{ route('setting.user-management.delete',[$user->id]) }}">
                                                            @csrf 
                                                            @method('DELETE')
                                                            <a href="{{ route('setting.user-management.view',[$user->id]) }}" title="Edit" class="btn btn-icon btn-light btn-sm mx-1">
                                    ...
                                    <div class="modal-dialog" role="document">
                                        ...
                                        <form method="POST" action="{{ route('setting.user-management.create') }}">
