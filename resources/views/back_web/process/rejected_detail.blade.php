                                ...
                                <div class="card card-custom">
                                    <div class="card-header flex-wrap border-0 pt-6 pb-0">
                                        <div class="card-title">
                                            <h3 class="card-label">Rejected
                                                <div class="text-muted pt-2 font-size-sm">Detail of Rejected</div></h3>
                                        </div>
                                        <h1><span><span class="badge  badge-danger">Rejected</span></span></h1>
                                    </div>
                                    <div class="card-body">
                                        <a href="/process/rejected" class="btn btn-secondary">Back</a><br><br>
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-6 my-2 my-md-0">
                                                                        <form>
                                                                            ...
                                                                            <div class="form-group row">
                                                                                <label for="reason-for-rejected" class="col-md-6 col-form-label text-md-left">{{ __('Reason For Rejected') }}</label>
                
                                                                                <div class="col-md-12">
                                                                                    <input id="reason-for-rejected" type="text" class="form-control @error('reason-for-rejected') is-invalid @enderror" name="reason-for-rejected" value="{{ $process->reason_for_rejected }}" required autocomplete="reason-for-rejected" readonly>
                                                                                </div>
                                                                            </div>
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-6 my-2 my-md-0">
                                                                        <form>
                                                                            ...
                                                                            <div class="form-group row">
                                                                                <label for="lokasi_beli_membership" class="col-md-6 col-form-label text-md-left">{{ __('Lokasi Beli Membership') }}</label>
                
                                                                                <div class="col-md-12">
                                                                                    <input id="lokasi_beli_membership" type="text" class="form-control @error('lokasi_beli_membership') is-invalid @enderror" name="lokasi_beli_membership" value="{{ $process->lokasi_beli_membership}}" required autocomplete="lokasi_beli_membership" readonly>
                                                                                </div>
                                                                            </div>
                                                                            ...
                                                                            <div class="form-group row">
                                                                                ...
                                                                                <div class="col-md-12">
                                                                                    <input id="layanan_perbaikan" type="text" class="form-control @error('layanan_perbaikan') is-invalid @enderror" name="layanan_perbaikan" value="{{ $process->alamat_penjemputan}}" required autocomplete="layanan_perbaikan" readonly>
                                                                                </div>
                                                                            </div>
                                                                            ...
                                                                            <div class="form-group row">
                                                                                ...
                                                                                <div class="col-md-12">
                                                                                    <input id="kronologis" type="text" class="form-control @error('kronologis') is-invalid @enderror" name="kronologis" value="{{ $process->kronologis}}" required autocomplete="kronologis" readonly>
                                                                                </div>
                                                                            </div>
                                                                        </form>
                                                                    </div>
