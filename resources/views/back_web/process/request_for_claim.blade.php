                                ...
                                <div class="card card-custom">
                                    <div class="card-header flex-wrap border-0 pt-6 pb-0">
                                        <div class="card-title">
                                            ...
                                            <div class="text-muted pt-2 font-size-sm">List of Request for Claim</div></h3>
                                        </div>
                                    </div>
                                    <div class="card-body">
                                        <!--begin: Search Form-->
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-4 my-2 my-md-0">
                                                            <div class="input-icon">
                                                                <input type="text" class="form-control" placeholder="Search IMEI" id="request_for_claim_search_query" />
                                                                <span>
                                        ...
                                        <form action="request-for-claim" method="POST" enctype="multipart/form-data" id="filter_form">
                                            @csrf
                                        ...
                                        <!--end: Search Form-->
                                        <!--begin: Datatable-->
                                        <table class="datatable datatable-borderless" id="request_for_claim">
                                            <thead>
                                                <tr>
                                                    <th>#</th>
                                                    <th>Customer Type</th>
                                            ...
                                            @foreach ($processes as $process)
                                                <tr>
                                                    ...
                                                    @endif
                                                    <td>
                                                        <form method="POST" action="{{ route('process.request-for-claim.action',[$process->id]) }}">
                                                            @csrf 
                                                            @method('PATCH')
