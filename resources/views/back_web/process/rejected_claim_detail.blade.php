                                ...
                                <div class="card card-custom">
                                    <div class="card-header flex-wrap border-0 pt-6 pb-0">
                                        <div class="card-title">
                                            <h3 class="card-label">Rejected Claim
                                                <div class="text-muted pt-2 font-size-sm">Detail of Rejected Claim</div></h3>
                                        </div>
                                        <h1><span><span class="badge  badge-danger">Rejected Claim</span></span></h1>
                                    </div>
                                    <div class="card-body">
                                        <a href="/process/rejected-claim" class="btn btn-secondary">Back</a><br><br>
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-6 my-2 my-md-0">
                                                                        <form>
                                                                            ...
                                                                            <div class="form-group row">
                                                                                <label for="reason-for-rejected-claim" class="col-md-6 col-form-label text-md-left">{{ __('Reason For Rejected Claim') }}</label>
                
                                                                                <div class="col-md-12">
                                                                                    <input id="reason-for-rejected-claim" type="text" class="form-control @error('reason-for-rejected-claim') is-invalid @enderror" name="reason-for-rejected-claim" value="{{ $process->reason_for_rejected_claim }}" required autocomplete="reason-for-rejected-claim" readonly>
                                                                                </div>
                                                                            </div>
                                                                        ...
                                                                        <form>
                                                                            <div class="form-group row">
                                                                                ...
                                                                                <div class="col-md-12">
                                                                                    ...
                                                                                    <input id="screen-has-problem" type="text" class="form-control @error('screen-has-problem') is-invalid @enderror" name="screen-has-problem" value="No" required autocomplete="screen-has-problem" readonly>
                                                                                    @endif
