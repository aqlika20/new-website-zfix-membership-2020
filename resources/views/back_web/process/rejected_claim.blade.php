                                ...
                                <div class="card card-custom">
                                    <div class="card-header flex-wrap border-0 pt-6 pb-0">
                                        <div class="card-title">
                                            ...
                                            <div class="text-muted pt-2 font-size-sm">List of Rejected</div></h3>
                                        </div>
                                    </div>
                                    <div class="card-body">
                                        <!--begin: Search Form-->
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-4 my-2 my-md-0">
                                                            <div class="input-icon">
                                                                <input type="text" class="form-control" placeholder="Search IMEI" id="rejected_search_query" />
                                                                <span>
                                        ...
                                        <form action="rejected-claim" method="POST" enctype="multipart/form-data" id="filter_form">
                                            @csrf
                                        ...
                                        <!--end: Search Form-->
                                        <!--begin: Datatable-->
                                        <table class="datatable datatable-borderless" id="rejected">
                                            <thead>
                                                <tr>
                                                    <th>#</th>
                                                    <th>Customer Type</th>
                                            ...
                                            @foreach ($processes as $process)
                                                <tr>
                                                    ...
                                                    <td>12 Bulan</td> 
                                                    @endif
                                                    <td>{{ $process->reason_for_rejected_claim }}</td>
                                                    <td>
                                                        <form>
                                                            <a href="{{ route('process.rejected-claim.detail',[$process->id]) }}" title="Detail" class="btn btn-icon btn-light btn-sm mx-1">
