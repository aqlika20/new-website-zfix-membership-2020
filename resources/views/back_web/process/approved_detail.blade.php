                                ...
                                <div class="card card-custom">
                                    <div class="card-header flex-wrap border-0 pt-6 pb-0">
                                        <div class="card-title">
                                            <h3 class="card-label">Approved
                                                <div class="text-muted pt-2 font-size-sm">Detail of Approved</div></h3>
                                        </div>
                                        <h1><span><span class="badge  badge-success">Approved</span></span></h1>
                                    </div>
                                    <div class="card-body">
                                        <a href="/process/approved" class="btn btn-secondary">Back</a><br><br>
                                                                    ...
                                                                    <div class="col-md-6 my-2 my-md-0">
                                                                        <form>
                                                                            ...
                                                                            <div class="form-group row">
                                                                                ...
                                                                                <div class="col-md-12">
                                                                                    <input id="assign" type="text" class="form-control @error('assign') is-invalid @enderror" name="assign" value="{{ $process->assign_by }}" required autocomplete="assign" readonly>
                                                                                </div>
                                                                            </div>
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-6 my-2 my-md-0">
                                                                        <form>
                                                                            ...
                                                                            <div class="form-group row">
                                                                                <div class="form-group row col-md-6">
                                                                                    <label for="imei-video" class="col-md-12 col-form-label text-md-left">{{ __('I
                                                                                    MEI Video') }}</label>
                                                                                    <div class="col-md-12">
