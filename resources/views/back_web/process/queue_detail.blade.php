                                    ...
                                    <div class="card-header flex-wrap border-0 pt-6 pb-0">
                                        <div class="card-title">
                                            <h3 class="card-label">Queue
                                                <div class="text-muted pt-2 font-size-sm">Detail of Queue</div></h3>
                                        </div>
                                        <h1><span><span class="badge  badge-warning">Queue</span></span></h1>
                                    </div>
                                    <div class="card-body">
                                        <a href="/process/queue" class="btn btn-secondary">Back</a><br><br>
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-6 my-2 my-md-0">
                                                                        <form>
                                                                            ...
                                                                            {{-- <div class="form-group row">
                                                                                <label for="voucher-type" class="col-md-6 col-form-label text-md-left">{{ __('Voucher Key') }}</label>
                
                                                                                <div class="col-md-12">
                                                                                    <input id="voucher-type" type="text" class="form-control @error('voucher-type') is-invalid @enderror" name="voucher-type" value="{{ $process->vouchers->serial_number }}" required autocomplete="voucher-type" readonly>
                                                                                </div>
                                                                            </div> --}}
                                                                            ...
                                                                            {{-- <div class="form-group row">
                                                                                ...
                                                                                <div class="col-md-12">
                                                                                    <select id="assign" class="form-control" name="assign" required autofocus>
                                        ...
                                        <form id="form" method="POST" action="{{ route('process.queue.action',[$process->id]) }}" class="text-center">
                                            @csrf 
                                            @method('PATCH')
                                            <button type="submit" name="action" value="1" title="Approve" class="btn btn-icon btn-light btn-lg mx-1" onclick='return confirm("Are you sure?")'>
                                                {{ Metronic::getSVG("media/svg/icons/Navigation/Check.svg", "svg-icon-md svg-icon-success") }}
                                            </button>
                                            <input type="hidden" id="reason-for-reject" name="reason_for_rejected" value=""/>
                                            <button type="button" title="Reject" class="btn btn-icon btn-light btn-lg mx-1" onclick='var reason_for_rejected=prompt("Reason For Rejected");document.getElementById("reason-for-reject").value = reason_for_rejected;if(reason_for_rejected){document.getElementById("form").submit();};'>
