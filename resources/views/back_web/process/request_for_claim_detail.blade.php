                                ...
                                <div class="card card-custom">
                                    <div class="card-header flex-wrap border-0 pt-6 pb-0">
                                        <div class="card-title">
                                            <h3 class="card-label">Request for Claim
                                                <div class="text-muted pt-2 font-size-sm">Detail of Request for Claim</div></h3>
                                        </div>
                                        <h1><span><span class="badge  badge-info">Request for Claim</span></span></h1>
                                    </div>
                                    <div class="card-body">
                                        <a href="/process/request-for-claim" class="btn btn-secondary">Back</a><br><br>
                                            ...
                                            <div class="card">
                                                <div class="card-header" id="headingTwo6">
                                                    <div class="card-title" data-toggle="collapse" data-target="#about-device">
                                                        <i class="flaticon2-protected"></i> About Device
                                                    </div>
                                                </div>
                                                                    ...
                                                                    <div class="col-md-6 my-2 my-md-0">
                                                                        <form>
                                                                            <div class="form-group row">
                                                                                ...
                                                                                <div class="col-md-12">
                                                                                    <input id="imei" type="text" class="form-control @error('imei') is-invalid @enderror" name="imei" value="{{ $process->imei }}" required autocomplete="imei" >
                                                                                </div>
                                                                            </div>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-6 my-2 my-md-0">
                                                                        <form>
                                                                            ...
                                                                            <div class="form-group row">
                                                                                <label for="created_at" class="col-md-6 col-form-label text-md-left">{{ __('Tanggal Pengajuan Perbaikan') }}</label>
                
                                                                                <div class="col-md-12">
                                                                                    <input id="created_at" type="text" class="form-control @error('created_at') is-invalid @enderror" name="created_at" value="{{ $process->created_at }}" required autocomplete="created_at" readonly>
                                                                                </div>
                                                                            </div>
                                                                            ...
                                                                            <div class="form-group row">
                                                                                ...
                                                                                <div class="col-md-12">
                                                                                    <input id="provinsi" type="text" class="form-control @error('provinsi') is-invalid @enderror" name="provinsi" value="{{ $process->provinsi }}" required autocomplete="provinsi" readonly>
                                                                                </div>
                                                                            </div>
                                        ...
                                        <label for="form" class="col-md-12 col-form-label text-md-center">{{ __('Action') }}</label>
                                        <form id="form" method="POST" action="{{ route('process.request-for-claim.action',[$process->id]) }}" class="text-center">
                                            @csrf 
                                            @method('PATCH')
                                            <button type="submit" name="action" value="3" title="Approve" class="btn btn-icon btn-light btn-lg mx-1" onclick='return confirm("Are you sure?")'>
                                                {{ Metronic::getSVG("media/svg/icons/Navigation/Check.svg", "svg-icon-md svg-icon-success") }}
                                            </button>
                                            <input type="hidden" id="reason-for-reject" name="reason_for_rejected_claim" value=""/>
                                            <button type="button" title="Reject" class="btn btn-icon btn-light btn-lg mx-1" onclick='var reason_for_rejected_claim=prompt("Reason For Rejected");document.getElementById("reason-for-reject").value = reason_for_rejected_claim;if(reason_for_rejected_claim){document.getElementById("form").submit();};'>
                                                {{ Metronic::getSVG("media/svg/icons/Navigation/Close.svg", "svg-icon-md svg-icon-danger") }}
                                            </button>
                                        </form>
                                        @endif
                                    </div>
